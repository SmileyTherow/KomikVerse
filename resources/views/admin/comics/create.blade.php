                ...
                <div class="flex justify-between items-center">
                    ...
                    <div>
                        <button type="button" onclick="resetForm()"
                            class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-lg font-medium">Reset</button>
                        <button type="submit" id="final-submit"
                            class="px-4 py-2 gradient-bg hover:opacity-90 text-white rounded-lg font-medium hidden">Tambah
                            Komik</button>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                <div class="flex items-center justify-center mb-6">
                    <div class="flex items-center">
                        <div id="circle-1"
                            class="step-active w-8 h-8 rounded-full flex items-center justify-center font-bold">1</div>
                        <div class="ml-2 font-medium">Informasi Dasar</div>
                    </div>
                    <div class="h-1 w-16 bg-gray-300 mx-2"></div>
                    <div class="flex items-center">
                        <div id="circle-2"
                            class="step-inactive w-8 h-8 rounded-full flex items-center justify-center font-bold">2</div>
                        <div class="ml-2 text-gray-500">Detail & Sinopsis</div>
                    </div>
                    <div class="h-1 w-16 bg-gray-300 mx-2"></div>
                    <div class="flex items-center">
                        <div id="circle-3"
                            class="step-inactive w-8 h-8 rounded-full flex items-center justify-center font-bold">3</div>
                ...
                <div id="step-1">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <div>
                            <label class="block text-gray-700 mb-2 font-medium">Judul Komik <span
                                    class="text-red-500">*</span></label>
                            <input type="text" id="title" name="title" value="{{ old('title') }}"
                                class="w-full px-4 py-3 border rounded-lg" placeholder="Contoh: One Piece Vol. 101"
                                required>
                            @error('title')
                        ...
                        <div>
                            ...
                            <input type="text" name="publisher" value="{{ old('publisher') }}"
                                class="w-full px-4 py-3 border rounded-lg" placeholder="Shonen Jump">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="year" value="{{ old('year', date('Y')) }}" min="1900"
                                max="{{ date('Y') }}" class="w-full px-4 py-3 border rounded-lg">
                        </div>
                    </div>
                ...
                <div id="step-2" class="hidden">
                    ...
                    <div class="mb-8">
                        <label class="block text-gray-700 mb-2 font-medium">Sinopsis <span
                                class="text-red-500">*</span></label>
                ...
                <div id="step-3" class="hidden">
                    <div class="mb-8">
                        <label class="block text-gray-700 mb-2 font-medium">Cover Komik <span
                                class="text-red-500">*</span></label>
                        <input type="file" id="cover-upload" name="cover" accept="image/*" class="w-full"
                            required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <div>
                            <label class="block text-gray-700 mb-2 font-medium">Jumlah Stok <span
                                    class="text-red-500">*</span></label>
                            <input type="number" id="stock-input" name="stock" value="{{ old('stock', 1) }}"
                                min="1" class="w-32 px-4 py-3 border rounded-lg" required>
                        </div>

                        <div>
                            <label class="block text-gray-700 mb-2 font-medium">Jumlah Halaman</label>
                            <input type="number" name="page_count" value="{{ old('page_count') }}" min="0"
                                class="w-32 px-4 py-3 border rounded-lg" placeholder="48">
                            @error('page_count')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <select name="language" class="w-full md:w-32 px-4 py-3 border rounded-lg">
                                <option value="">Pilih Bahasa</option>
                                <option value="ID" {{ old('language') == 'ID' ? 'selected' : '' }}>Indonesia - Bahasa
                                    Indonesia</option>
                                <option value="EN" {{ old('language') == 'EN' ? 'selected' : '' }}>Inggris - English
                                </option>
                                <option value="JP" {{ old('language') == 'JP' ? 'selected' : '' }}>Jepang - 日本語
                                </option>
                                <option value="KR" {{ old('language') == 'KR' ? 'selected' : '' }}>Korea - 한국어
                                </option>
    ...
    <script>
        ...
        function nextStep() {
            ...
            if (currentStep === 2) {
                ...
                if (syn.length < 100) {
                    alert('Sinopsis minimal 100 karakter');
                    return;
                }
            }
